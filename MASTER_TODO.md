...
- **Wave 6** (commit `520d0f5`): Inserted 35 user-listed venues — 25 NYC (ids 15561-15585): Marcel, Lord's, Cafe Luluc, Hen House, Commerce Inn, Bubby's Tribeca, Cocina Consuelo, Golden Hof, Faicco's, Milano Market UES + Westside, Di Palo's, Pisillo FiDi + Midtown, Agata & Valentina + GF, Avra Madison + 48th + Rockefeller + 33rd&9th, 2nd Ave Deli Midtown + UES, Shelsky's, GO Catering, Fermento. + 2 Miami (15586-15587): Vecinos Miami Beach, True Loaf Bakery. + 8 Austin (15588-15595): Wholy Bagel x2, Nervous Charlie's x2, Rosen's Bagel Co x2, David Doughie's, Rockstar Bagels. Scripts: `scripts/wave6-{insert,a-nyc-backlog,b-nyc-newlist,c-miami-austin}.{py,json}`.
- **Wave 7** (commit `cd1c852`): 9 Miami + 4 NYC + 1 LA. **Miami (15596-15604):** Boia De, Mandolin Aegean Bistro, Walrus Rodeo, The Surf Club Restaurant, Fooq's, Gramps Getaway, Lung Yai Thai Tapas, Joe's Stone Crab, Makoto — relocated to MIAMI_DATA per user (had been skipped from wave 6 as Miami-only). **NYC (15605-15608):** Montagu's Gusto Murray Hill (user clarified via mgustonyc.com), Breakfast by Salt's Cure x3 (West Village, Prospect Heights, Carroll Gardens — user clarified via breakfastbysaltscure.com). **LA (15609):** Corteza at Sendero (Ritz-Carlton at L.A. LIVE — user redirected from NYC to LA). Scripts: `scripts/wave7-{insert.py,miami.json}`. **Still skipped no-match:** DiSO's (food truck), Bubby's High Line (closed), Lighthouse Miami (unverifiable), Sazon Tribeca (closed 2018).
- **Reservation audit** (commit `baf79ad`): scanned 7,528 entries. Fixed 11 bugs: (A) 3 NYC venues had Resy URL but reservation=walk-in — set to Resy: Via Carota (1005), Bridges (1216), Coqodaq (1461). (B) 2 entries had reserveUrl pointing to a /search results page — cleared: Dhamaka (1028), The Eighty Six (1737). (C) 6 wave-6 Austin bagel shops had Toast takeout URLs in reserveUrl — cleared (these are walk-in): Wholy Bagel x2 (15588, 15589), Rosen's Bagel Co x2 (15592, 15593), David Doughie's (15594), Rockstar Bagels (15595). Tourist attractions (Empire State, MET, Wrigley, etc.) keep their ticket URLs as designed. Audit script `scripts/reservation-audit.py` reusable for future passes; findings JSON in `scripts/reservation-audit.json`. **Still flagged:** Blue Sushi Sake Grill Uptown (9230) — has venue reservations URL but reservation field empty, needs platform identification.
