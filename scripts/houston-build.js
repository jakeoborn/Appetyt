...
if(actIdx > -1 && !html.substring(actIdx, actIdx + 10000).includes("'houston'")){
  ...
  'houston': [
    {name:'Space Center Houston',category:'Museum',price:'From $30',rating:'4.7',reviews:'20K+',emoji:'🚀',url:'https://www.viator.com/Houston-attractions/Space-Center-Houston/d765-a12122?utm_source=dimhour&utm_medium=referral',desc:'Touch a moon rock, see Mission Control, tour NASA. Allow a full day.'},
    {name:'Houston Museum District Pass',category:'Museum',price:'From $25',rating:'4.8',reviews:'5K+',emoji:'🎨',url:'https://www.viator.com/Houston-tours/Museum-Tickets-and-Passes/d765-g25?utm_source=dimhour&utm_medium=referral',desc:'19 museums including MFAH and Natural Science. The Menil Collection is free.'},
    {name:'Houston Food Tour',category:'Food Tour',price:'From $65',rating:'4.8',reviews:'2K+',emoji:'🍖',url:'https://www.viator.com/Houston-tours/Food-Tours/d765-g6-c80?utm_source=dimhour&utm_medium=referral',desc:'BBQ, Tex-Mex, Vietnamese, and Gulf Coast seafood. Houston is America most diverse food city.'},
    {name:'Buffalo Bayou Kayak Tour',category:'Outdoor',price:'From $35',rating:'4.6',reviews:'1K+',emoji:'🛶',url:'https://www.viator.com/Houston-tours/Kayaking-Tours/d765-g61?utm_source=dimhour&utm_medium=referral',desc:'Paddle through downtown Houston on the bayou. Sunset tours are magical with skyline reflections.'},
    {name:'Galveston Island Day Trip',category:'Day Trip',price:'From $50',rating:'4.5',reviews:'3K+',emoji:'🏖️',url:'https://www.viator.com/Houston-tours/Day-Trips-and-Excursions/d765-g5?utm_source=dimhour&utm_medium=referral',desc:'Beach, Strand historic district, and seafood. 50 miles from Houston. The closest beach to the city.'},
    {name:'Houston Astros Game at Minute Maid Park',category:'Sports',price:'From $25',rating:'4.8',reviews:'10K+',emoji:'⚾',url:'https://www.viator.com/Houston-attractions/Minute-Maid-Park/d765-a17791?utm_source=dimhour&utm_medium=referral',desc:'Retractable roof stadium with a train on the outfield wall. The 2022 World Champs play here.'},
  ],`;
