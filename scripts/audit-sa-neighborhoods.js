...
fs.writeFileSync(path.join(__dirname, 'sa-neighborhood-audit.json'),
  JSON.stringify({ city: 'San Antonio', checked, in_bounds: inB, no_bounds: noB, severe: bySev.severe, moderate: bySev.moderate, edge: bySev.edge }, null, 2));
console.log('San Antonio: checked=' + checked + ' in=' + inB + ' no-bounds=' + noB + ' severe=' + bySev.severe.length + ' moderate=' + bySev.moderate.length + ' edge=' + bySev.edge.length);
