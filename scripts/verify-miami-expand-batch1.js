...
const REPORT_PATH = 'scripts/verify-miami-expand-batch1-report.json';
const MIN_ID = 4083;

const BBOX = [25.55, 26.00, -80.45, -80.10]; // Miami-Dade bbox
...
async function main() {
  ...
  const declStart = html.indexOf('const MIAMI_DATA=');
  ...
  console.log(`Verifying ${targets.length} MIAMI expand-batch-1 entries (id >= ${MIN_ID})`);
