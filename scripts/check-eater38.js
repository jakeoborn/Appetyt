...
// Rudys Chicken removed — permanently closed 2026-02-28
const dallas = ['The Chumley House','61 Osteria','Walloons Restaurant','Smoke N Ash BBQ','Sanjh Restaurant','Ari Korean BBQ','Roots Southern Table','Cenzos Pizza','Lucia','Bushi Bushi','Uchiko Plano','Taco y Vino','Restaurant Beatrice','The Heritage Table','El Carlos Elegante','Tango Room','Billy Can Can','Nuri Steakhouse','Written by the Seasons','Royal China','Starship Bagel','Namo','Mirador','Partenope Ristorante','Green Point Seafood','El Come Taco','Terry Blacks Barbecue','Gemma Restaurant','Tatsu Dallas','Mikes Chicken','Ngon Vietnamese Kitchen','Quarter Acre','Goodwins','Via Triozzi','Meridian Restaurant','Mot Hai Ba','Harvest at the Masonic'];
